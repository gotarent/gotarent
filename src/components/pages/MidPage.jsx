      ...
      <div className="main-con">
        <div className="container">
          <div className="rightContainer">
            <div className="head-text">
              <h2>
                Rent a Room near you or sharte yours when you're not using it!
              </h2>
            </div>
                ...
                <ul>
                  <li>
                    ...
                    <p className="sec-text">
                      All rentals include insurance and 24/7 assistance
                    </p>
                  </li>
                  <li>
                    <span className="pri-text">
                      Accomodation for every moment
                    </span>
                    <p className="sec-text">
                      All rentals include insurance and 24/7 assistance
                    </p>
        ...
        <div className="blue-text">
          <div className="sec-blue-text">
            ...
            <p className="sharukh-text">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci,
              molestias quas? Corporis, aliquid? Cumque, provident possimus
              natus architecto atque inventore perspiciatis quo recusandae eaque
              tenetur necessitatibus, amet, quas dicta rem?
            </p>
          </div>
          <div className="btn">
